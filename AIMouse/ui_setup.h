...
"}"));
        ...
        pushButton_2 = new QPushButton(frame_gy);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(60, 240, 80, 18));
...
"}"));
    ...
    void retranslateUi(QWidget *SetUp)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("SetUp", "&Pushbutton", nullptr));
