...
void Waveform::onDeviceChannelAndSampRate(int channels, int srate)
{
    ...
    emit sendToStatusBar("waveform:设备已连接");
...
void Waveform::onModifyDeviceName(QString name)
{
    ...
    emit sendToStatusBar("waveform:" + name + "设备已连接");
}
...
void Waveform::onConnectUpdate(CONNECTUPDATE con)
{
    ...
    if(CU_UNCON == con){
        ...
        emit sendToStatusBar("waveform:设备已断开连接");
    }
...
void Waveform::on_btn_open_clicked()
{
...
/**
 * 触发弹出打标窗口
 * @brief Waveform::on_btn_add_event_clicked
 */
void Waveform::on_btn_add_event_clicked()
{
...
/**
 * 开始读取脑电数据
 * @brief Waveform::on_btn_start_acquisition_clicked
 */
void Waveform::on_btn_start_acquisition_clicked()
{
...
/**
 * 记录edf文件
 * @brief Waveform::on_btn_start_record_clicked
 */
void Waveform::on_btn_start_record_clicked()
{
...
/**
 * 停止脑电数据
 * @brief Waveform::on_btn_stop_acquisition_clicked
 */
void Waveform::on_btn_stop_acquisition_clicked()
{
