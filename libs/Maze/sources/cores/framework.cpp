...
void GameFramework::setLevel(Difficulty l)
{
    this->l = l;
}
...
QList<MapBlock> GameFramework::getWayBlocks()
{
    ...
    return map->getWayBlocksAStar(playerX, playerY);
}
...
Difficulty GameFramework::getLevel()
{
    return l;
}
...
void GameFramework::setMapSize(int rows, int cols) {
    map->resize(rows, cols);
}

void GameFramework::setPlayerSpeed(int scale)
{
